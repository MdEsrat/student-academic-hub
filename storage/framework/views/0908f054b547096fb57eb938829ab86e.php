...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="container mx-auto px-6 py-4 relative">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="navbar-brand lg:bg-white/20 flex items-center space-x-2">
                ...
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('profile') ?? '#'); ?>" class="flex items-center text-white/90 hover:text-white transition-colors group">
                        <?php if($user->profile_picture ?? null): ?>
                            <img src="<?php echo e(asset('storage/' . $user->profile_picture)); ?>" alt="Profile" class="w-8 h-8 rounded-full border-2 border-white/20 group-hover:border-white/40 transition-colors object-cover">
                        <?php else: ?>
            ...
            <div id="mobile-menu" class="lg:hidden hidden absolute top-full right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-xl z-50 max-h-96 overflow-y-auto">
                <div class="py-2">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-home w-5 text-center mr-3 text-blue-600 dark:text-blue-400"></i>
                        <span>Dashboard</span>
                    </a>
                    
                    <?php if(($user->role ?? 'student') === 'student'): ?>
                        <a href="<?php echo e(route('courses.my-courses')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                            <i class="fas fa-book w-5 text-center mr-3 text-green-600 dark:text-green-400"></i>
                            <span>My Courses</span>
                        </a>
                        <a href="<?php echo e(route('grades.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                            <i class="fas fa-chart-line w-5 text-center mr-3 text-purple-600 dark:text-purple-400"></i>
                            <span>CGPA Tracker</span>
                        </a>
                        <a href="<?php echo e(route('faculty-reviews.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors bg-blue-50 dark:bg-gray-700">
                    ...
                    <?php elseif(($user->role ?? 'student') === 'faculty'): ?>
                        <a href="#" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <?php elseif(($user->role ?? 'student') === 'admin'): ?>
                        <a href="#" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 mt-2 pt-2">
                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <a href="<?php echo e(route('settings')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
    ...
    <div id="sidebar" class="sidebar sidebar-bg">
        <div class="sidebar-header">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-800"><?php echo e($user->name ?? 'User'); ?></p>
                        <p class="text-xs text-gray-600"><?php echo e(ucfirst($user->role ?? 'student')); ?></p>
                    </div>
                </div>
        ...
        <div class="p-6">
            <div class="space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
                    <i class="fas fa-home text-lg"></i>
                    <span class="sidebar-text">Dashboard</span>
                </a>
                <?php if(($user->role ?? 'student') === 'student'): ?>
                    <a href="<?php echo e(route('courses.my-courses')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
                        <i class="fas fa-book text-lg"></i>
                        <span class="sidebar-text">My Courses</span>
                    </a>
                    <a href="<?php echo e(route('grades.index')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
                        <i class="fas fa-chart-line text-lg"></i>
                        <span class="sidebar-text">CGPA Tracker</span>
                    </a>
                    <a href="<?php echo e(route('faculty-reviews.index')); ?>" class="sidebar-item active flex items-center space-x-3 px-4 py-3">
                ...
                <div class="border-t border-gray-200 pt-4 mt-4">
                    <a href="<?php echo e(route('profile')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
                    ...
                    <a href="<?php echo e(route('settings')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
    ...
    <div class="main-content" id="mainContent">
        <div class="container mx-auto px-4 lg:px-6 py-8">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p><?php echo e($currentSemesterDetails['display'] ?? 'Semester information not available'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php if($facultyAssignments && $facultyAssignments->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $facultyAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="course-card">
                            <div class="course-header">
                                <div class="course-info">
                                    <h3 class="course-code">
                                        <?php echo e($assignment->course->course_code); ?>

                                    </h3>
                                    <p class="course-name"><?php echo e($assignment->course->course_name); ?></p>
                                    <div class="faculty-info">
                                        <i class="fas fa-user"></i>
                                        <span><?php echo e($assignment->faculty->name); ?></span>
                                    </div>
                                    <div class="faculty-info mt-1">
                                        <i class="fas fa-graduation-cap"></i>
                                        <span><?php echo e($assignment->course->credits); ?> Credits</span>
                                    </div>
                                </div>
                                <div class="course-icon">
                                    <?php echo e(substr($assignment->course->course_code, 0, 1)); ?>

                                </div>
                            </div>
                            
                            <div class="course-footer">
                                <button onclick="openReviewModal(<?php echo e(json_encode($assignment)); ?>)" 
                                        class="rate-button">
            ...
            <?php else: ?>
                <div class="bg-white rounded-lg shadow-md p-12 text-center">
                    ...
                    <div class="text-sm text-gray-400">
                        <p>Current semester: <?php echo e($currentSemesterDetails['display'] ?? 'Not available'); ?></p>
        ...
        <div class="container mx-auto px-4 lg:px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('dashboard')); ?>" class="text-gray-300 hover:text-white transition-colors">Dashboard</a></li>
                        <li><a href="<?php echo e(route('courses.my-courses')); ?>" class="text-gray-300 hover:text-white transition-colors">My Courses</a></li>
                        <li><a href="<?php echo e(route('grades.index')); ?>" class="text-gray-300 hover:text-white transition-colors">Grades</a></li>
    ...
    <div id="reviewModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form id="reviewForm" method="POST" action="<?php echo e(route('faculty-reviews.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="px-6 py-4">
                    <div id="modalContent">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('overall_rating', <?php echo e($i); ?>)" 
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('teaching_quality', <?php echo e($i); ?>)" 
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('communication', <?php echo e($i); ?>)" 
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('course_organization', <?php echo e($i); ?>)" 
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('helpfulness', <?php echo e($i); ?>)" 
                        ...
                        <div class="mb-4 rating-section">
                            ...
                            <div class="flex items-center space-x-1">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <button type="button" onclick="setRating('fairness', <?php echo e($i); ?>)" 
...
<?php /**PATH E:\student-hub\resources\views/faculty-reviews.blade.php ENDPATH**/ ?>