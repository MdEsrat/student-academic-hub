        ...
        <div class="animate-fade-in">
            ...
            <div class="mb-12">
                <div class="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 transition transform hover:scale-105 inline-flex items-center space-x-2">
                        <i class="fas fa-user-plus"></i>
                        <span>Sign Up</span>
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-blue-600 transition transform hover:scale-105 inline-flex items-center space-x-2">
    ...
    <section class="py-16">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
                <a href="<?php echo e(route('login')); ?>" class="bg-white/20 backdrop-blur-md p-8 rounded-xl text-center text-white hover:bg-white/30 transition-all transform hover:scale-105 animate-slide-up">
                ...
                <a href="<?php echo e(route('register')); ?>" class="bg-white/20 backdrop-blur-md p-8 rounded-xl text-center text-white hover:bg-white/30 transition-all transform hover:scale-105 animate-slide-up" style="animation-delay: 0.1s;">
...
<?php /**PATH E:\student-hub\resources\views/welcome.blade.php ENDPATH**/ ?>