...
<body class="bg-gray-50 min-h-screen">
            ...
            <div id="mobile-menu" class="lg:hidden hidden absolute top-full right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-xl z-50 max-h-96 overflow-y-auto">
                <div class="py-2">
                    ...
                    <?php if(($user->role ?? 'student') === 'student'): ?>
                        ...
                        <a href="<?php echo e(route('faculty-reviews.index')); ?>" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
        ...
        <div class="p-6">
            <div class="space-y-2">
                ...
                <?php if(($user->role ?? 'student') === 'student'): ?>
                    ...
                    <a href="<?php echo e(route('faculty-reviews.index')); ?>" class="sidebar-item flex items-center space-x-3 px-4 py-3">
    ...
    <div class="main-content" id="mainContent">
        <div class="container mx-auto px-4 lg:px-6 py-8">
            <!-- Dashboard Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-4">Welcome, <?php echo e($user->name ?? 'User'); ?>!</h1>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($cgpa ?? 0, 2)); ?></p>
                        </div>
                    </div>
                </div>
                <!-- Total Courses -->
                <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($totalCourses ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                <!-- Current Semester -->
                <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($completedSemesters ?? 0); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                    ...
                    <a href="<?php echo e(route('courses.my-courses')); ?>" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors text-center inline-block">
                        Go to My Courses
                    </a>
                </div>
                <!-- CGPA Tracker -->
                <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                    ...
                    <a href="<?php echo e(route('grades.index')); ?>" class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 rounded-lg transition-colors text-center inline-block">
                        Track CGPA
                    </a>
                </div>
                <!-- Resources -->
...
<?php /**PATH E:\student-hub\resources\views/dashboard.blade.php ENDPATH**/ ?>