                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                        ...
                        <div class="form-floating">
                            <input type="email" 
                                   id="email" 
                                   name="email" 
                                   class="w-full px-3 py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-floating">
                            <input type="password" 
                                   id="password" 
                                   name="password" 
                                   class="w-full px-3 py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH E:\student-hub\resources\views/auth/login.blade.php ENDPATH**/ ?>