            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @else
                        ...
                        <a href="{{ route('resource-hub') }}" class="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-blue-400 transition">Resources</a>
                        <div class="flex items-center space-x-3">
                            <a href="{{ route('profile') }}" class="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-blue-400 transition">
            ...
            <div id="mobile-menu" class="md:hidden hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
                <div class="px-4 py-2 space-y-2">
                    ...
                    @else
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-2 mt-2">
                            <a href="{{ route('profile') }}" class="block py-2 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-blue-400 transition">
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
                    ...
                    <div class="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg">
                        ...
                        <a href="/resource-hub" class="bg-accent text-white px-6 py-2 rounded-full hover:bg-green-700 transition inline-block">Explore Resources</a>
                    </div>
                </div>

                <!-- CGPA Tracker -->
                <div class="bg-gradient-to-br from-yellow-50 to-orange-100 dark:from-gray-800 dark:to-gray-700 p-8 rounded-xl shadow-lg hover:shadow-xl transition">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-semibold mb-4 text-secondary dark:text-yellow-400">CGPA Tracker</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">Monitor your academic progress with our intuitive CGPA calculator and semester tracking.</p>
                        
                        <div class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                            Track <span class="font-semibold text-secondary">GPA</span> • <span class="font-semibold text-secondary">Semester</span> Analysis
                        </div>
                        <a href="/cgpa-tracker" class="bg-secondary text-white px-6 py-2 rounded-full hover:bg-yellow-600 transition inline-block">Start Tracking</a>
                    </div>
                </div>
            </div>
        </div>
